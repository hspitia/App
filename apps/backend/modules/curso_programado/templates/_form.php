...
<form action="<?php echo url_for('curso_programado/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?curso_programado_curso_id='.$form->getObject()->getCursoProgramadoCursoId().'&curso_programado_institucion_id='.$form->getObject()->getCursoProgramadoInstitucionId().'&curso_programado_periodo_academico_id='.$form->getObject()->getCursoProgramadoPeriodoAcademicoId().'&estudiante_id='.$form->getObject()->getEstudianteId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
