...
abstract class BaseCursoProgramadoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'Programacion_id'    => new sfWidgetFormInputHidden(),
    ...
    $this->setValidators(array(
      ...
      'Programacion_id'    => new sfValidatorChoice(array('choices' => array($this->getObject()->get('Programacion_id')), 'empty_value' => $this->getObject()->get('Programacion_id'), 'required' => false)),
