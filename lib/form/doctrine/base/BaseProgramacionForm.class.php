...
/**
 * Programacion form base class.
 *
 * @method Programacion getObject() Returns the current form's model object
 *
 * @package    siglo21
 * @subpackage form
 ...
 */
abstract class BaseProgramacionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'Programacion', 'column' => array('codigo')))
    );

    $this->widgetSchema->setNameFormat('programacion[%s]');
